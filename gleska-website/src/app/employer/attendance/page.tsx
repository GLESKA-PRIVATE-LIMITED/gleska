...
export default function EmployerAttendancePage() {
  ...
  return <AccountManagementShell kind="employer" name={user.name} accountLabel={formatEmployerType(user.employer_type)} employerType={user.employer_type} profileHref="/employer/company-profile" onLogout={() => void logout()}>
