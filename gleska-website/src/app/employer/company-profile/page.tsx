  ...
  return (
    <div className="flex min-h-screen bg-[#f4f6fc] font-sans text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      >
        ...
        {/* Go Premium Badge */}
        <div className="pt-4 border-t border-slate-200/80 dark:border-slate-800 w-full">
          {isSidebarOpen ? (
            <div className="rounded-2xl bg-linear-to-r from-blue-600 to-indigo-600 p-4 text-white shadow-md">
              <div className="flex items-center gap-2 mb-2">
                <Crown size={18} className="text-amber-300" />
                <span className="font-bold text-sm">Go Premium</span>
              </div>
              <p className="text-xs text-blue-100 mb-3">
                Unlock unlimited AI worker matching and priority verification.
              </p>
              <button
                type="button"
                onClick={() => router.push("/employer/dashboard")}
                className="w-full rounded-xl bg-white px-3 py-2 text-xs font-bold text-blue-700 hover:bg-blue-50 transition"
              >
                Upgrade Plan
              </button>
            </div>
            ...
            <button
              type="button"
              onClick={() => router.push("/employer/dashboard")}
              className="flex justify-center p-2 text-amber-500 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl"
              title="Go Premium"
            >
              <Crown size={20} />
            </button>
