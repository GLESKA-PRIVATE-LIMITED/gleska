...
-- Correct 040 for deployments where the original function is already present.
-- RETURNS TABLE creates an output variable named worker_profile_id, so all
-- job_matches references must remain explicitly qualified.
